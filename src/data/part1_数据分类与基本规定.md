...
<!-- chapter_no=4; chapter_title=时空数据分类; section_type=术语定义; knowledge_type=term_definition -->
# 4 时空数据分类
...
<!-- chapter_no=5; chapter_title=基本规定; section_type=术语定义; knowledge_type=term_definition -->
# 5 基本规定

<!-- chapter_no=5.1; chapter_title=时空基准; section_type=术语定义; knowledge_type=term_definition -->
## 5.1 时空基准

<!-- chapter_no=5.1.1; chapter_title=空间基准; section_type=术语定义; knowledge_type=term_definition -->
### 5.1.1 空间基准
...
<!-- chapter_no=5.1.2; chapter_title=时间基准; section_type=术语定义; knowledge_type=term_definition -->
### 5.1.2 时间基准

<!-- section_type=术语定义; knowledge_type=term_definition -->
日期应采用公历纪元，时间应采用北京时间。

<!-- chapter_no=5.2; chapter_title=数据组织与格式; section_type=术语定义; knowledge_type=term_definition -->
## 5.2 数据组织与格式

<!-- chapter_no=5.2.1; chapter_title=数据单元划分; section_type=术语定义; knowledge_type=term_definition -->
### 5.2.1 数据单元划分
...
<!-- chapter_no=5.2.2; chapter_title=数据格式; section_type=术语定义; knowledge_type=term_definition -->
### 5.2.2 数据格式
